        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* <div className="lg:col-span-2 space-y-6">
            ...
            {/* <div className="card-luxury rounded-2xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="text-lg font-heading font-semibold text-infinity-400">
                    {latestBooking.id}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="text-lg font-heading font-semibold text-soft-white">
                    {latestBooking.roomName}
                  </div>
                </div>
            ...
            <div className="bg-royal-500/10 border border-royal-500/30 rounded-2xl p-8">
              <h3 className="text-xl font-heading font-semibold mb-4 text-royal-300">
            ...
            <div className="card-luxury rounded-2xl p-8 sticky top-8">
              ...
              {/* <div className="space-y-4 mb-6">
                <div className="flex items-center text-lavender-300 font-body">
                  ...
                  <div>
                    <div className="font-heading font-medium text-soft-white">
                      Ngày nhận phòng
                    </div>
