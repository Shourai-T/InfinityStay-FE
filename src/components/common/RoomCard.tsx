...
import { Users, Star, Sparkles, MapPin } from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="relative md:w-2/5 h-64 md:h-auto">
            <img
              ...
              loading="lazy"
            />
            <div className="absolute inset-0 bg-gradient-to-r md:bg-gradient-to-t from-midnight-900/80 via-transparent to-transparent" />
            ...
            {room.type === "vip" && (
              <div className="absolute top-4 left-4 bg-gradient-gold px-3 py-1 rounded-full flex items-center space-x-1">
                ...
                <span className="text-xs font-heading font-bold text-midnight-900">
                  VIP
                </span>
              </div>
            )}
